...
<svg xmlns="http://www.w3.org/2000/svg" className="h-6   duration-200 hover:fill-green-500 self-end  active:fill-purple-400 w-6" viewBox="0 0 20 20" fill="currentColor">
...
<div className="flex flex-col  relative ">
	<svg xmlns="http://www.w3.org/2000/svg" className="h-6  hover:scale-[100.8%] duration-200 z-10 top-5 left15  place-self-end  hover:fill-green-400  active:fill-purple-400 w-6" viewBox="0 0 20 20" fill="currentColor">
  <path d="M5 4a2 2 0 012-2h6a2 2 0 012 2v14l-5-2.5L5 18V4z" />
