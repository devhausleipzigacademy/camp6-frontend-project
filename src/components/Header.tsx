export function Header() {
	return (
  <>
  <header className="h-[8vh]  bg-slate-100 border-b-2 border-black border-opacity-40 w-full items-center text-5xl flex justify-between  flex-row">
				<p className="font-heading  font-extrabold ml-6">
         Logo
         </p>
