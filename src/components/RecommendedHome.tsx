...
import { RecommendedItemProps } from "../database/TypesNConsts";
	...
	return (
		<>
			...
			<div className="flex flex-row gap-4 px-2">
				<RecommendedItem
					link="https://justcreative.com/best-tablets-for-graphic-designers/"
				...
				/>
				<RecommendedItem
					link="https://www.idropnews.com/how-to/this-mind-blowing-pinch-trick-can-share-photos-on-your-iphone-and-ipad/183827/"
					image="./src/assets/RecommendedTwo.jpeg"
					title="Pinching an image has never been easier with this simple trick"
					recommendationCount={2581}
				/>
				<RecommendedItem
					link="https://bombilla.co/megan"
